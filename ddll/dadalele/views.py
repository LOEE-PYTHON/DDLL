...
def index(request):
    return render(request, 'dadalele/index.html')


def login(request):
    u_name = request.COOKIES.get("u_name", '')
    context = {'u_name':u_name, 'error_name':0, 'error_pwd':0}
    return render(request, 'dadalele/login.html',context)

def admin(request):
    return render(request, 'dadalele/admin.html')
...
def stu_info_list(request):
    ...
    return render(request, "dadalele/stu_info_list.html", context)


def course_info_list(request):
    return render(request,"dadalele/course_info_list.html")

def class_view(request):
    return render(request,"dadalele/class_view.html")

def stu_info_into(request):
    return render(request,"dadalele/stu_info_into.html")

def stu_info_view(request):
    return render(request,"dadalele/stu_info_view.html")

def stu_info_change(request):
    return render(request,"dadalele/stu_info_change.html")



def course_into(request):
    return render(request,"dadalele/course_into.html")

def course_view(request):
    return render(request,"dadalele/course_view.html")

def course_change(request):
    return render(request,"dadalele/course_change.html")
    
def class_grouping(request):
    return render(request,"dadalele/class_grouping.html")

def class_list(request):
    return render(request,"dadalele/class_list.html")

def class_into(request):
    return render(request,"dadalele/class_into.html")
...
def stu_info_list_handle(request):
...
def stu_info_view_handle(request):
    ...
    return render(request, 'dadalele/stu_info_view.html', context)
...
def student_add_handle(request):
    ...
    return render(request,'dadalele/stu_info_into.html', context)
...
def student_info_alter(request):
    if request.method == 'POST':
        ...
        return render(request, 'dadalele/stu_info_change.html/', context)
